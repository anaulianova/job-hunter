...
Usage:
    uv run scripts/cv_export.py --company elliptic --date jun18
        → looks for submitted/cv_elliptic_jun18.md, falls back to cv.md
        → writes submitted/elliptic_jun18.pdf
...
Tailoring workflow:
    ...
    2. Claude writes tailored version to submitted/cv_{company}_{date}.md
    3. User validates
...
def main():
    ...
    parser.add_argument("--input",
                        help="Explicit markdown source (default: submitted/cv_{company}_{date}.md → cv.md)")
